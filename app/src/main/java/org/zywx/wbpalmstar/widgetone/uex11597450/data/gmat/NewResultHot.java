...
/**
 * Created by fire on 2017/8/31  11:47.
 */

public class NewResultHot {
    ...
    public void setContentmoduleid(String contentmoduleid) {
    ...
    public String getContentinputtime() {
        return contentinputtime;
    }

    public void setContentinputtime(String contentinputtime) {
        this.contentinputtime = contentinputtime;
    }
    ...
    public String getImages_pictures() {
        return images_pictures;
    }

    public void setImages_pictures(String images_pictures) {
        this.images_pictures = images_pictures;
    }
