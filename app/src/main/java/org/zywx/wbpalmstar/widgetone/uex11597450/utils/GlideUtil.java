...
public class GlideUtil {
    ...
    public static void load(Object loadObj, ImageView imageView) {
        loadDefault(loadObj, imageView, false, DecodeFormat.PREFER_ARGB_8888, DiskCacheStrategy.RESULT);
    }

    public static void loadNoDefalut(Object loadObj, ImageView imageView) {
        loadNoDefault(loadObj,imageView,false,DecodeFormat.PREFER_ARGB_8888,DiskCacheStrategy.RESULT);
    }
    ...
    public static void loadDefaultOverrideNoAnim(Object loadObj, ImageView imageView, int overrideW, int overrideH, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, overrideW, overrideH, R.drawable.place_img, R.drawable.place_img, 0, asGif, format, null, diskcacheStrategy);
    }
    ...
    public static void loadDefaultTransformation(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, Transformation transformation, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.place_img, R.drawable.place_img, R.anim.image_load, asGif, format, transformation,
                diskcacheStrategy);
    }
    ...
    public static void loadDefault(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.place_img, R.drawable.place_img, R.anim.image_load, asGif, format, null, diskcacheStrategy);
    }
    ...
    public static void loadDefaultNoAnim(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.place_img, R.drawable.place_img, 0, asGif, format, null, diskcacheStrategy);
    }
