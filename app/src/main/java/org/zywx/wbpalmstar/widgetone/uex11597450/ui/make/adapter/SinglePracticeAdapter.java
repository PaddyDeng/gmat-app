...
public class SinglePracticeAdapter extends BaseRecyclerViewAdapter<QuestionBankData> {

    Random mRandom;

    public SinglePracticeAdapter(Context context, List<QuestionBankData> data, RecyclerView.LayoutManager mLayoutManager) {
    ...
    public void bindItemViewData(final BaseRecyclerViewHolder holder, int position, final QuestionBankData itemData) {
        ...
        holder.getTextView(R.id.single_contact_title_tv).setText(mContext.getString(R.string.str_single_item_title,
...
//            holder.getTextView(R.id.single_contact_btn).setText(mContext.getString(R.string.str_again_make));
        ...
        holder.getTextView(R.id.single_contact_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemData.getHasMakeTest() != C.END) {
                    //去做题
                    TestActivity.startTestActivity(holder.itemView.getContext(), itemData, TestType.SINGLE_PRACTICE);
                }
            }
        });
        ...
        holder.getTextView(R.id.single_result_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //查看结果
                SimulationResultActivity.startSearchResult(holder.itemView.getContext(), itemData, TestType.SINGLE_PRACTICE);
            }
        });
