...
public class ChartView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        pieChartCircleRadius = a.getDimension(
                R.styleable.ChartView_circleRadius,
                pieChartCircleRadius);

        mTextSize = a.getDimension(R.styleable.ChartView_textSize, mTextSize) / getResources().getDisplayMetrics().density;
    ...
    private void drawAllSectors(Canvas canvas) {
        ...
        for (PieceDataHolder pieceDataHolder : pieceDataHolders) {
            ...
            if (!TextUtils.isEmpty(pieceDataHolder.marker)) {
