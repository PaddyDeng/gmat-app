package org.zywx.wbpalmstar.widgetone.uex11597450.push;
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                case MSG_SET_ALIAS:
                    ...
                    JPushInterface.setAliasAndTags(GmatApplication.getInstance(), (String) msg.obj, null, mAliasCallback);
                    break;
...
//                    JPushInterface.setAliasAndTags(getApplicationContext(), null, (Set<String>) msg.obj, mTagsCallback);
    ...
    public static void stopPush() {
        JPushInterface.stopPush(GmatApplication.getInstance());
    }
    ...
    public static void setAlias(String uid) {
        uid = "lgw" + uid;
        if (JPushInterface.isPushStopped(GmatApplication.getInstance())) {
            JPushInterface.resumePush(GmatApplication.getInstance());
        }
