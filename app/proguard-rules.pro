...
# keep 使用 webview 的类
-keepclassmembers class  org.zywx.wbpalmstar.widgetone.uex11597450.ui.common.DealActivity {
   public *;
}
...
-keep class org.zywx.wbpalmstar.widgetone.uex11597450.data.** { *; }
...
-dontwarn com.baidu.ocr.ui.camera.**
-keep class com.baidu.ocr.ui.camera.** { *;}
-dontwarn com.baidu.ocr.ui.crop.**
-keep class com.baidu.ocr.ui.crop.** { *;}
-dontwarn com.baidu.ocr.ui.util.**
-keep class com.baidu.ocr.ui.util.** { *;}
